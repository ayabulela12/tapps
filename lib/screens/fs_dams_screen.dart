...
class FSDamsScreen extends ConsumerWidget {
  const FSDamsScreen({super.key});

  // Dummy list of Free State dams
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Using Firebase data for Free State dams
    final fsDamsAsync = ref.watch(provinceDamsProvider('FS'));
