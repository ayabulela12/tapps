...
class MPDamsScreen extends ConsumerWidget {
  const MPDamsScreen({super.key});

  // Dummy list of Mpumalanga dams
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Using Firebase data for Mpumalanga dams
    final mpDamsAsync = ref.watch(provinceDamsProvider('MP'));
