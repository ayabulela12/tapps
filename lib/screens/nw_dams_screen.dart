...
class NWDamsScreen extends ConsumerWidget {
  const NWDamsScreen({super.key});

  // Dummy list of North West dams
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Using Firebase data for North West dams
    final nwDamsAsync = ref.watch(provinceDamsProvider('NW'));
