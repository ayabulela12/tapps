...
class NelsonMandelaMetroScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Using the collection name for Nelson Mandela Metro with correct document ID
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Please ensure the Nelson Mandela Metro data is properly set up in Firestore.',
                                style: GoogleFonts.outfit(
