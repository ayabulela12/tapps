...
class LPDamsScreen extends ConsumerWidget {
  const LPDamsScreen({super.key});

  // Dummy list of Limpopo dams
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Using Firebase data for Limpopo dams
    final lpDamsAsync = ref.watch(provinceDamsProvider('LP'));
