...
class KZNDamsScreen extends ConsumerWidget {
  ...
  // Dummy list of KwaZulu-Natal dams
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Using Firebase data for KwaZulu-Natal dams
    final kznDamsAsync = ref.watch(provinceDamsProvider('KZN'));
